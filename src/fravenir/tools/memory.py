...
This module intentionally contains only the MCP-facing adapters. Domain behavior
remains in fravenir.core so board/graph tools can be added without turning
server.py into a monolith.
"""
